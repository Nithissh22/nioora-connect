import { Tv, Monitor, Projector, Box, Refrigerator, Waves, UtensilsCrossed, Microwave, Droplets, Fan, AirVent, Thermometer, Laptop, Printer, Cctv, Router, BatteryCharging, Zap, Wrench, PenTool, Wind, Component } from "lucide-react";

export const services = [
  { id: "tv", name: "TV", category: "Electronics", icon: Tv },
  { id: "home-theatre", name: "Home Theatre System", category: "Electronics", icon: Monitor }, // approximate
  ...
  { id: "dishwasher", name: "Dishwasher", category: "Appliances", icon: UtensilsCrossed }, // approximate
  ...
  { id: "kitchen-chimney", name: "Kitchen Chimney", category: "Appliances", icon: Fan }, // approximate
  ...
  { id: "grinder", name: "Grinder", category: "Appliances", icon: PenTool }, // approximate
];

export const categories = ["All", "Appliances", "Electronics", "Home Services"];
